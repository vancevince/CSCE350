 ...
 * 2021-10-07
 *
 * COPY of original homework, but with better methods.
 * changed void search method to return type list
 *
...
class BinarySearchTree {
 ...
 private: 
  ...
  list<BSTNode> searchList(double target, BSTNode*& subTree);

};

void BinarySearchTree::searchList(double target) {
  list<BSTNode> searchList(target, root);
}

list<BSTNode> BinarySearchTree::searchList(double target, BSTNode*& subTreeRoot) {
 //TODO left off here 
}
